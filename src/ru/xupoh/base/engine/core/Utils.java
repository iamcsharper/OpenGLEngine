...
public class Utils {
	...
	public static String[] removeMultipleSpaces (String... strings) {
		for (int i = 0; i < strings.length; ++i) {
			strings[i] = strings[i].replaceAll("/\\s\\s+/", " ");
		}
	...
	public static <T> T[] shrinkArray(T[] arr, int resultSize) {
